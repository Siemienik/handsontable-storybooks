...
export const RtlColumnSummary1 = mapConfigToStory(configurations.ColumnSummary, {rtl: true});
...
export const ColumnSummary1 = mapConfigToStory(configurations.ColumnSummary);
...
export const HfColumnSummary1 = mapConfigToStory({...configurations.ColumnSummary, ...formulas});
